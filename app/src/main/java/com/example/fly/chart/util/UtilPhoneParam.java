package com.example.fly.chart.util;
...
//		return height;
	...
	public static String getIMSI(Context context) {
		try {
			...
			telMgr = (TelephonyManager) context
					.getSystemService(Context.TELEPHONY_SERVICE);
			@SuppressLint("MissingPermission") String imsi = telMgr.getSubscriberId();
			if (imsi == null) {
				imsi = "0";
			}
			return imsi;
	...
	public static String getMEID(Context context) {
		try {
			...
			telMgr = (TelephonyManager) context
					.getSystemService(Context.TELEPHONY_SERVICE);
			@SuppressLint("MissingPermission") String meid = telMgr.getDeviceId();
			if (meid == null) {
				meid = "";
			}
			return meid;
