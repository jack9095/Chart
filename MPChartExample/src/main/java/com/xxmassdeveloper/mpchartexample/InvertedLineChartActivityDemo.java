...
public class InvertedLineChartActivityDemo extends DemoBase implements OnSeekBarChangeListener,
    ...
    private void setData(int count, float range) {
        ...
        set1.setDrawValues(false);  // true 折线  false 曲线
